            ...
            <div className="flex flex-wrap items-center justify-between gap-5 w-full">
                ...
                <div id="collapseMenu" className="max-lg:hidden lg:block! max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50">
                    ...
                    <ul className="lg:flex gap-x-4 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                        ...
                        <li className="">
                            <NavLink to="/" className={({isActive}) => isActive ? "hover:text-blue-700 text-blue-700 block font-medium text-[15px]" : "max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"}>Home
                            </NavLink>
                        </li>
                        <li className=""><NavLink to="/shop" className={({isActive}) => isActive ? "hover:text-blue-700 text-blue-700 block font-medium text-[15px]" : "max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"}>Shop</NavLink>
                        </li>
                        <li className=""><NavLink to="/about" className={({isActive}) => isActive ? "hover:text-blue-700 text-blue-700 block font-medium text-[15px]" : "max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"}>About</NavLink>
                        </li>
                        <li className="">
                            <NavLink to="/contact" className={({isActive}) => isActive ? "hover:text-blue-700 text-blue-700 block font-medium text-[15px]" : "max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"}>Contact
                            </NavLink>
                        </li>
                ...
                <div className="flex max-lg:ml-auto space-x-4">
                    <NavLink to="/signup"><button className="px-4 py-2 text-sm rounded-full font-medium cursor-pointer tracking-wide text-slate-900 border border-gray-400 bg-transparent hover:bg-gray-50 transition-all">Login</button></NavLink>
                    <NavLink to="/signup"><button className="px-4 py-2 text-sm rounded-full font-medium cursor-pointer tracking-wide text-white border border-blue-600 bg-blue-600 hover:bg-blue-700 transition-all">Sign
                        up</button></NavLink>
